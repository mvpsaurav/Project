...
//change ingraham_instute
$q2 = "SELECT ingraham_instute FROM admin WHERE id=1";
$q21 = mysqli_query($con,$q2);
echo $ingraham_instute_disp = mysqli_fetch_array($q21);
...
<link rel="stylesheet" type="text/css" href="engine/css/slideshow.css" media="screen" />
	<style type="text/css">.slideshow ingraham instute{display:none}</style>
...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:#4E4E4E"><div style="text-align:left;color:#FFFFFF"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF"><?php echo $colgdisp['Ingraham instute'];?><h1> Ingraham instute </h1></a></font></b><marquee direction="left" height="50%">
			<?php echo $disp['Ingraham instute']; ?></marquee></div></th>
    </tr>
    <tr>
...
<li><img src="data1/images/ing.jpg" alt="Multispeciality College Campus" title="Multispeciality College Campus" id="wows1_0"/></li>
<li><img src="data1/images/garden.jpg" alt="colorful garden" title="colorful garden" id="wows1_1"/></li>
<li><img src="data1/images/complex.jpg" alt="Best sport complex" title="best sport complex" id="wows1_2"/></li>
<li><img src="data1/images/infra.jpg" alt="Best Of Class Infrastructure" title="Best Of Class Infrastructure" id="wows1_3"/></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title="Multispeciality College Campus"><img src="data1/tooltips/ing.jpg" alt="Multispeciality College Campus"/>1</a>
<a href="#" title="colorful garden"><img src="data1/tooltips/garden.jpg" alt="colorful garden"/>2</a>
<a href="#" title="Best sport complex"><img src="data1/tooltips/complex.jpg" alt="Best sport complex"/>3</a>
<a href="#" title="Best Of Class Infrastructure"><img src="data1/tooltips/infra.jpg" alt="Best Of Class Infrastructure"/>4</a>
</div></div>
<span class="wsl"></span>
	...
	?>
	<center>
	  <h2><b><font size="+3"><?php echo $colgdisp['ingraham instute'];?>
	    </font></b></h2>
	</center>
    <center><img src="images/ingraham polytechnic.jpg" width="696" height="488"></center>
    <p><center>
      <p>Ingraham instute is a renowned institution in Ghaziabad Uttar Pradesh,India.It was established in 1926 and the motto of the institution is Be Ye Light and the vision is "educating the whole person in mind body and spirit".</p>
      <p><strong><font size="+2"><?php echo $colgdisp['ingraham instute'];?></font></strong> <b>-</b> <font size="+1"><?php echo $introdisp['colgintro']; ?></font></p>
    </center></p>
	<?php
    error_reporting(1);
	}
	...
	?>
      ...
      <center><font size="+2"><b style="color:#191B7E"><div style="background-color:#969BFB">College Updates</div><br></b></font></center>
      	<marquee direction="up" height="100%" onMouseOver="stop()" onMouseOut="start()">
			<center><a href="index.php?option=cdrive" style="text-decoration:none"><font size="+1"><b></b></font></a></center><br>
